...
class questionFormat {
  ...
  const handleChange = (event) => {
    ...
    if ((questions[currentQuestions].q1*questions[currentQuestions].q2)/questions[currentQuestions].q2 == input.current) {
  ...
  return (
    <div className="App">
      ...
      <div className="question-text">{`${questions[currentQuestions].q1*questions[currentQuestions].q2} / ${questions[currentQuestions].q2} =`}</div>
      </div>
